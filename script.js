...
function gameover1() {
  if (
    ...
    (a[6].innerHTML == "X" && a[4].innerHTML == "X" && a[2].innerHTML == "X")
  ) {
    ...
    (a[6].innerHTML == "O" && a[4].innerHTML == "O" && a[2].innerHTML == "O")
  ) {
...
function reset() {
  let x = document.getElementsByClassName("col1");
